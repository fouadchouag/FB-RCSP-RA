"""CV5 - ACMCSP. EA in loader + bandpass + z-score + SVM C=4."""
import sys, os, csv
import numpy as np
...
for subj in subjects:
    ...
    for fold,(tr,te) in enumerate(skf.split(X,y)):
        ...
        acmcsp.fit_population(X_pop)
        Ftr=acmcsp.fit_transform(X[tr],y[tr]); Fte=acmcsp.transform(X[te])
